...
public class InAppNotify{
    ...
    public static var theme:Theme = Themes.coreDirection
...
public struct Themes {
    ...
    public static let coreDirection:Theme = Theme(
        titleFont                   : UIFont.gothamMedium(size: 12.0),
        subtitleFont                : UIFont.gothamMedium(size: 12.0),
        backgroundColor             : UIColor(hex: 0x666666, alpha: 1.0),
        dragIndicatorColor          : UIColor.clear,//UIColor(red:0.90, green:0.90, blue:0.90, alpha:1),
        titleColor                  : UIColor.appGreen,
        subtitleColor               : UIColor.appGreen,
        shadowColor                 : UIColor.yellow.cgColor,
        inputTextBackgroundColor    : UIColor.purple,
        inputTextColor              : UIColor.green,
        sendButtonHighlightedColor  : UIColor.darkGray,
        sendButtonNormalColor       : UIColor.white,
        separatorLineColor          : UIColor.white
    )
...
public struct NotificationSize {
    ...
    public static let imageSize         : CGFloat = 22
    public static let imageOffset       : CGFloat = 15
    public static var height            : CGFloat = UIApplication.shared.isStatusBarHidden ? 44 : 64  // Its not effecting
    public static var textOffset        : CGFloat = 45
}
