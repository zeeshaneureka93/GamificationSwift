...
//        NotificationSize.height = UIApplication.shared.isStatusBarHidden ? 44 : 64
...
//        NotificationSize.textOffset = (imageView.image == nil) ? 18 : 65
    ...
    open func setupFramesAndPositionViews() {
        ...
        titleLabel.frame.origin         = CGPoint(x: NotificationSize.textOffset, y: imageView.frame.origin.y + 5)
