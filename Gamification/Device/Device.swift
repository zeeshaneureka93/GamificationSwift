...
//        return versionCode
//    }
//    static var info = "\(Device.version())_iOS\(UIDevice.current.systemVersion)"
//
//    static let defaultLang = defaultLanguage
//    static let lang = currentLanguage
//
